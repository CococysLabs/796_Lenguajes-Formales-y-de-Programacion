# 796_Lenguajes-Formales-y-de-Programacion
Contenido, ejemplos y recursos del curso de Lenguajes Formales y de Programación
...
1. Sigue esta secuencia exacta de comandos en tu terminal para descargar exclusivamente la carpeta de trabajo asignada:
    ...
    # 1. Clonar el repositorio sin descargar archivos completos
      git clone --no-checkout [https://github.com/CococysLabs/796_Lenguajes-Formales-y-de-Programacion.git](https://github.com/CococysLabs/796_Lenguajes-Formales-y-de-Programacion.git)

    cd 796_Lenguajes-Formales-y-de-Programacion
